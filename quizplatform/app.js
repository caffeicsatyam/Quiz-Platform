...
var quiz = {
    ...
    this.showResult = function (scr) {
        ...
        for (var j = 0; j < totalque; j++) {
            var res = quiz.JS[j].score == 0 
                ? '<span class="wrong">' + quiz.JS[j].score + '</span><i class="fa fa-remove c-wrong"></i>' 
                : '<span class="correct">' + quiz.JS[j].score + '</span><i class="fa fa-check c-correct"></i>';
